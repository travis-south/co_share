<h1><?php echo isset($edit_user_heading)? $edit_user_heading : lang('edit_user_heading');?></h1>
<p><?php echo isset($edit_user_subheading)? $edit_user_subheading : lang('edit_user_subheading');?></p>
