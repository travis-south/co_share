 ...
 */
class Mylist_ajax extends Ajax_Controller {
    ...
    public function create()
    {
        ...
        $html_item = Modules::run('mylist/_pagelet_item', array(
            'title' => $title,
            'completed' => FALSE,
            'thumbnail' => $thumbnail,
        ));
    ...
    public function toggle($id,$completed)
    {
		//update on the databaes
		$this->load->model('cosharetask_model');
		$this->cosharetask_model->update($id,!$completed);
...
/* Location: ./application/modules/mylist/controllers/mylist_ajax.php */
